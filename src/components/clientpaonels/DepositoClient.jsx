...
const rows = [
  ...
  createData(12, 10292, 'CARDANO', 'cardanoADA.png', 'ADA', '05 de Abrir de 2023'),
  createData(13, 2292, 'CARDANO', 'cardanoADA.png', 'ADA', '15 de Agosto de 2023'),
  createData(14, 1292, 'CARDANO', 'cardanoADA.png', 'ADA', '25 de Agosto de 2023'),
];

function DepositoClient({ user, setText, total, setTotal }) {
  
  const classes = useStyles()
  const [depositos, setDepositos] = useState(rows);
                ...
                return (
                  <TableRow hover role="checkbox" tabIndex={-1} key={row.id}>
                     <TableCell align={'left'}>
                        ...
                        >
                        <ArrowUpward sx={{  color: 'green', fontWeight: 'bold', fontSize: '.9rem', '@media (max-width: 800px)': { fontSize: '.6rem' }, }} />
                         <Typography 
                            sx={{
                                ml: .5,                                          
                                fontSize: '14px',                                
