...
import { CurrencyBitcoin, Home,  Logout, QueryStats, AccountBalance, FacebookOutlined, Twitter, Instagram, LinkedIn, InsertInvitation, } from "@mui/icons-material";
import { AppBar, Avatar, Box,  Button,  IconButton, Menu, MenuItem,  Stack, Tab, Tabs, Toolbar, Typography } from "@mui/material";
import { useState } from 'react';
import ClientHome from '../components/clientpaonels/ClientHome';
import Investimentos from '../components/clientpaonels/Investimentos';
import Convites from '../components/clientpaonels/Convites';
import Operacoes from '../components/clientpaonels/Operacoes';
...
function DashboardClient({userLogin, setUserLogin}) {
  ...
  return (
    <>
    <AppBar elevation={1} position="sticky" sx={{ bgcolor: '#00809b' }}>
        <Toolbar>          
      ...
      <div className={classes.body}>
        ...
        >
            <Box 
              ...
              />
              <Tab
                icon={<InsertInvitation className={classes.icon}/>} 
                iconPosition="start" 
                label={
                    <Typography className={classes.text}>
                        CONVITES
              ...
              <Tab
                ...
                <div className={classes.item}>
                    <Logout  onClick={() => handleLogout()} className={classes.icon}/>
                      <Typography  onClick={() => handleLogout()} className={classes.text}>
                        SAIR
                      </Typography>              
                </div>
                </Tabs>
            ...
            >
                <TabPanel value={value} index={0}>
                    <ClientHome user={userLogin} />
                </TabPanel>         
              <TabPanel value={value} index={1}>
                <Investimentos user={userLogin} />
            </TabPanel>
            <TabPanel value={value} index={2}>
                  <Convites user={userLogin} />
              </TabPanel>
             <TabPanel value={value} index={3}>
                <Operacoes user={userLogin} />
              </TabPanel>       
            </Box>
        </Stack>
      </div>
