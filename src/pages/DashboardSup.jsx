...
import {  CurrencyBitcoin,  Home,  Logout, QueryStats, FacebookOutlined, Twitter, Instagram, LinkedIn, DownloadForOffline, PointOfSale } from "@mui/icons-material";
import { AppBar, Avatar, Box,  Button,  IconButton, Menu, MenuItem,  Stack, Tab, Tabs, Toolbar, Typography } from "@mui/material";
import { useState } from 'react';
import Homesup from '../components/superpainel/Homesup';
import Criptosup from '../components/superpainel/Criptosup';
import Yieldsup from '../components/superpainel/Yieldsup';
import Investmentsup from '../components/superpainel/Investmentsup';
import Saquesup from '../components/superpainel/Saquesup';
import Anuncios from '../components/superpainel/Anuncios';
import Publicidadesup from '../components/superpainel/Publicidadesup';
...
function DashboardSup({userLogin, setUserLogin}) {
